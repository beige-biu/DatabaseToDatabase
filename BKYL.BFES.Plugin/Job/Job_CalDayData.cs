...
{
    public class Job_CalDayData : BaseJob
    {
        ...
        private void GetCustomModel(DateTime dt)
        {
            using (IDataBase idatabase = DalFactory.GreateIDataBase(base.S_DBSource)) //AV01H_WINJ ,timestamp,a_winj_01h
            {
                ...
                //灰量                
                sql = $"select sum(wsh+gfh) from MES_DAY_HFLR t where record_time>{ DataBaseFactory.ConvertTimeString(dt.AddDays(-1), DataBaseType.Oracle)} "
        ...
        private List<BF_TEST> GetCustomCal(DateTime dt)
        {
            ...
            if (modelAV05M_LININGTC != null && modelAV05M_LININGTC.Count > 0)
            {
                ...
                model.VALUE = ((modelAV05M_LININGTC.FindAll(m => m.CLP10_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI1 > 0).Average(m => m.CLP10_TI1) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI2 > 0).Average(m => m.CLP10_TI2) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI3 > 0).Average(m => m.CLP10_TI3) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI4 > 0).Average(m => m.CLP10_TI4) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI5 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI5 > 0).Average(m => m.CLP10_TI5) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI6 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI6 > 0).Average(m => m.CLP10_TI6) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI7 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI7 > 0).Average(m => m.CLP10_TI7) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP10_TI8 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP10_TI8 > 0).Average(m => m.CLP10_TI8) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI1 > 0).Average(m => m.CLP11_TI1) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI2 > 0).Average(m => m.CLP11_TI2) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI3 > 0).Average(m => m.CLP11_TI3) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI4 > 0).Average(m => m.CLP11_TI4) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI5 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI5 > 0).Average(m => m.CLP11_TI5) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI6 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI6 > 0).Average(m => m.CLP11_TI6) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI7 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI7 > 0).Average(m => m.CLP11_TI7) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP11_TI8 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP11_TI8 > 0).Average(m => m.CLP11_TI8) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP12_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP12_TI1 > 0).Average(m => m.CLP12_TI1) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP12_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP12_TI2 > 0).Average(m => m.CLP12_TI2) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP12_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP12_TI3 > 0).Average(m => m.CLP12_TI3) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP12_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP12_TI4 > 0).Average(m => m.CLP12_TI4) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP14_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP14_TI1 > 0).Average(m => m.CLP14_TI1) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP14_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP14_TI2 > 0).Average(m => m.CLP14_TI2) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP14_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP14_TI3 > 0).Average(m => m.CLP14_TI3) : 0)
                             + (modelAV05M_LININGTC.FindAll(m => m.CLP14_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP14_TI4 > 0).Average(m => m.CLP14_TI4) : 0)) / 24;
                modelList.Add(model);
                #endregion

                #region  //炉腰温度7
                model = new BF_TEST() { TIMESTAMP = InsertTime, ID = "10000000000010", ID_DESC = "炉腰温度7" };
                model.VALUE = ((modelAV05M_LININGTC.FindAll(m => m.CLP7_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI1 > 0).Average(m => m.CLP7_TI1) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI2 > 0).Average(m => m.CLP7_TI2) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI3 > 0).Average(m => m.CLP7_TI3) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI4 > 0).Average(m => m.CLP7_TI4) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI5 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI5 > 0).Average(m => m.CLP7_TI5) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI6 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI6 > 0).Average(m => m.CLP7_TI6) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI7 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI7 > 0).Average(m => m.CLP7_TI7) : 0)
                               + (modelAV05M_LININGTC.FindAll(m => m.CLP7_TI8 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP7_TI8 > 0).Average(m => m.CLP7_TI8) : 0)
                               ) / 8;
                ...
                model.VALUE = ((modelAV05M_LININGTC.FindAll(m => m.CLP6_TI1 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI1 > 0).Average(m => m.CLP6_TI1) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI2 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI2 > 0).Average(m => m.CLP6_TI2) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI3 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI3 > 0).Average(m => m.CLP6_TI3) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI4 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI4 > 0).Average(m => m.CLP6_TI4) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI5 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI5 > 0).Average(m => m.CLP6_TI5) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI6 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI6 > 0).Average(m => m.CLP6_TI6) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI7 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI7 > 0).Average(m => m.CLP6_TI7) : 0)
                              + (modelAV05M_LININGTC.FindAll(m => m.CLP6_TI8 > 0).Count > 0 ? modelAV05M_LININGTC.FindAll(m => m.CLP6_TI8 > 0).Average(m => m.CLP6_TI8) : 0)) / 8;
                #endregion
                modelList.Add(model);
