...
namespace BKYL.BFES.Plugin
{
    class Job_HotModel : BaseJob
    {
        ...
        public override void RunTask(DateTime currentTime)
        {
            ...
            if(IsStopBf!=0)//高炉休风
            {
                m_HotModel = new HotModel(S_DBSource);
    ...
    public class HotModel
    {
        ...
        public HotModel(DatabaseSource dbs)
        {
            m_dbs = dbs;
        }
        ...
        public void Init()
        {
            ...
            using (IDataBase idatabase = DalFactory.GreateIDataBase(m_dbs))
            {
                ...
                //查询上次出铁时间
                DateTime dt_up = idatabase.GetDateTime(string.Format(sql_Time_up, "M_TAPSTART", "V_TAPPING", "TIMESTAMP", UtilsConvert.GetOraString(CurrentTime)));
                //查询上上次出铁时间
                DateTime dt_up_up = idatabase.GetDateTime(string.Format(sql_Time_up_up, "M_TAPSTART", "V_TAPPING", "TIMESTAMP", UtilsConvert.GetOraString(CurrentTime)));
                //本次数据
        ...
        public void Calc()
        {
            ...
            //去除煤气利用率判断
            COR_STATUS1 = COR_STATUS2 = COR_STATUS3 = COR_STATUS4 = true;
