...
using System.IO;
using System.Text;
namespace DatabaseToDatabase.Utils
{
    public class ReadConfig
    {
        ...
        public ReadConfig()
        {
            try
            {
                ...
                if (BKYL.Jobs.Base.Gloabls.IsDebug && debugFiles != null && debugFiles.Length > 0)
                {
        ...
        void GetParamConfig()
        {
            BKYL.Jobs.Base.Gloabls.IsDebug = System.Configuration.ConfigurationManager.AppSettings["IsDebug"] == null ? false : System.Configuration.ConfigurationManager.AppSettings["IsDebug"].ToBool();
            Log.DebugLog = BKYL.Jobs.Base.Gloabls.IsDebug;
            ...
            if (BKYL.Jobs.Base.Gloabls.IsDebug)
            {
                DataBaseFactory.IsEnableLogEvent = BKYL.Jobs.Base.Gloabls.IsDebug;
        ...
        private TableConfig ReadFileContext(StreamReader sr, AppConfig appConfig)
        {
            ...
            try
            {
                ...
                while ((line = sr.ReadLine()) != null)
                {
                    ...
                    {
                        tableConfig.S_TablePrimaryKey = Split[1].Replace(appConfig.ReplaceComma, ",").Replace("\"\"\"", "\"");
                        continue;
                    }
                    ...
                    {
                        tableConfig.T_TablePrimaryKey = Split[1].Replace(appConfig.ReplaceComma, ",").Replace("\"\"\"", "\"");
                        continue;
                    }
                    ...
                    {
                        tableConfig.UpdateSql = Split[1].Replace(appConfig.ReplaceComma, ",").ToUpper();
                        continue;
                    }
