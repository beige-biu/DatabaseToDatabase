...
namespace BKYL.Jobs.Base.Utils
{
    ...
    {
        //private static readonly Dictionary<PropertyInfo, IReflectValue> dic =
        //    new Dictionary<PropertyInfo, IReflectValue>();
        ...
        internal static IReflectValue GetPropertyGetterWrapper(PropertyInfo propertyInfo)
        {
            ...
            //if (!dic.TryGetValue(propertyInfo, out property))
            //{
            //    property = CreatePropertyGetterWrapper(propertyInfo);
            //    dic.Add(propertyInfo, property);
            //}
            return property;
        }
